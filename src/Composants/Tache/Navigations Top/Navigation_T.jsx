    ...
    const notifications = [
      {
        id: 1,
        icon: 'LINE',
        title: 'Nouvelle application LINE soumise par "Craft-Dev"',
        time: '10 Juin 2025 à 21h 59min',
        status: 'En attente',
        type: 'line'
      },
      {
        id: 2,
        icon: 'Ps',
        title: "L'téléchargement de l'application PhotoShop a explosé +200%",
        time: '10 Juin 2025 à 21h 59min',
        status: '',
        type: 'photoshop'
      }
        ...
        <div className="px-6 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={notificationsRef}>
              ...
              {/* Modal Notifications */}
              {showNotifications && (
                <div className="absolute right-[-20px] top-12 w-96 bg-white rounded-lg shadow-lg border z-50">
                    ...
                    {notifications.map((notification) => (
                      <div key={notification.id} className="p-4 border-b hover:bg-gray-50 flex items-start space-x-3">
                        <div className={`w-10 h-10 rounded flex items-center justify-center text-white font-bold ${
                          notification.type === 'line' ? 'bg-green-500' : 'bg-blue-500'
                        }`}>
                          {notification.icon}
                        </div>
